...
function renderCounts(){
  $('#draftCount').textContent = Object.keys(loadJson(STORE_KEY, {})).length;
  $('#alertCount').textContent = loadAlerts().filter(a => a.status !== 'closed').length;
  $('#inventoryCount').textContent = loadJson(INVENTORY_KEY, []).length;
}
